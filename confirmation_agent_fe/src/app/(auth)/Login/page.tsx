  ...
  const verifyAccessKey = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        window.location.assign("/SchedulerAgent/CallsStatusLogger");
      } else {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ width: "80%", position: "relative" }} className="flex">
          ...
          <input
            ...
            id="access_key"
            className="block w-full p-3 ps-9 bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-white focus:border-white shadow-xs placeholder:text-body"
